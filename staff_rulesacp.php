...
echo "
			<div class='row clearfix'>
				...
				if ($result->num_rows > 0) {
					...
					while($rules = $result->fetch_assoc()) {
					echo"
                      ...
                      <tr>				  
                        <td>
							...
							<div class='input-group'>
								...
								<input style='box-shadow: 0 0 1px rgba(0,0,0, .4);' type='text' name='title' size='50' maxlength='100' class='form-control' value='".$rules["title"]."' required>
							</div>	
                        </td>
					  </tr>
                      <tr>				  
                        <td>
							...
							<div class='input-group'>
								...
								<input style='box-shadow: 0 0 1px rgba(0,0,0, .4);' type='text' name='title_de' size='50' maxlength='100' class='form-control' value='".$rules["title_de"]."' required>
							</div>	
                        </td>
					  </tr>
                      <tr>					  
                        <td>
							...
							<div class='input-group'>
								...
								<textarea style='box-shadow: 0 0 1px rgba(0,0,0, .4);' type='text' name='content' size='450' maxlength='1260' class='form-control' value='".$rules["content"]."' required></textarea>
							</div>	
                        </td>						
                      </tr>
                      <tr>					  
                        <td>
							...
							<div class='input-group'>
								...
								<textarea style='box-shadow: 0 0 1px rgba(0,0,0, .4);' type='text' name='content_de' size='450' maxlength='1260' class='form-control' value='".$rules["content_de"]."' required></textarea>
							</div>	
                        </td>						
                      </tr>                      					  
                      <tr>					  
						<td>						
							<button type='submit' name='rules_sup' class='btn btn-primary btn-round'>
								<i class='now-ui-icons ui-1_check'></i> ".RULES_SAVE."
							</button>
							</submit>
                        </td>							
                      </tr>						
